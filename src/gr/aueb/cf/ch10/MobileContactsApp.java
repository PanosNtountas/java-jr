...
import gr.aueb.cf.ch7.StringInputApp;
...
//        contact[0] = contact[positionToUpdate][0];
//        contact[1] = contact[positionToUpdate][1];
//        contact[2] = contact[positionToUpdate][2];
    ...
    public static void log(Exception e, String... message) {
        try(PrintStream ps = new PrintStream(new FileOutputStream(path.toFile(), true))) {
            ...
            System.out.printf("%s", (message.length == 1) ? message[0] : "");
