...
/**
 * Υλοποιει εναν απλο calculator που παρεχει τις υπηρεσιες add, sub, mul, dic, mod.
 * Εμφανιζει ενα Μενου προς τον χρηστη με επιλογες, λαμβανει την τιμη της επιλογης και στη συνεχεια
 * δυο ακομα τιμες των num1, num2. Και τελικα εμφανιζει το αποτελεσμα.
 */
